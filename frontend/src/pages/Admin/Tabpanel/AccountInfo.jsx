...
//     const handleSetData = (name, email, pass, image, phone) => {
//       setName(name)
//       setEmailId(email)
//       setPhone(phone)
//       setPass(pass)
...
//     //   dispatch(getAdminPatch(Name,EmailId,Phone,Password,Image)).then((res)=>{
...
//             gap={3}
//           >
//             <Input borderColor={'teal.500'} color={"gray.600"} readOnly value={admin.Name}></Input>
//             <Input borderColor={'teal.500'} color={"gray.600"} readOnly value={admin.EmailId}></Input>
//             <Input borderColor={'teal.500'} color={"gray.600"} readOnly value={admin.Phone}></Input>
//             <InputGroup size="md">
//               <Input
//                 color={"gray.600"}
