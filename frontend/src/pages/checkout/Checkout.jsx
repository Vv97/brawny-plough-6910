    ...
    <>
      ...
      >
        <Box w={["95%", "95%", "55%"]}>
          <Center>
            <Box w="60%" mb={8} bgColor={"white"} mt={6}>
              <Heading fontSize={"22"} mt={7} textAlign="left" mb="3">
                {" "}
                1. Shipping Address
              </Heading>
              <hr />
              <Text fontSize={"15"} textAlign="left" mt={7}>
                * Country /Region
              </Text>
              <Select
                id="delivery-country"
                mt={7}
                data-test="delivery-country-field"
                class="selectField-0-3-35 selectField-d0-0-3-36 "
          ...
          <Center>
            <Box w="60%">
              <Heading fontSize={"20"} mt={1} mb={"3"} textAlign="left">
                {" "}
                2. Pyement Selection{" "}
              </Heading>
        ...
        >
          ...
          <Heading size="md" color="#28bdb7" mb="25px">{` Amount To Pay : $${
          ...
          <Button
            ...
            borderRadius="0px"
            w={["95%", "95%", "95%"]}
          >{`Proceed To Pay $${cartTotal == 0 ? 0 : cartTotal + 18.5}`}</Button>
          <Link to="/skin">
            <Button
              m="auto"
              onClick={handleProceed}
      ...
      <Modal isCentered isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button onClick={onClose} bgColor="green.200" borderRadius="0px">
              Close
            </Button>
          </ModalFooter>
        </ModalContent>
